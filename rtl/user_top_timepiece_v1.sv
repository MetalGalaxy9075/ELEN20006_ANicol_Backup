...
module user_top_timepiece_v1 #(
  ...
  always @(*)
    case (mode_sel)
      // Stopwatch
      2'b01: begin
        ui_top_out.led           = sw_out.led;
        ui_top_out.hours_disp    = sw_out.hours_disp;
        ui_top_out.minutes_disp  = sw_out.minutes_disp;
        ui_top_out.seconds_disp  = sw_out.seconds_disp;
        ui_top_out.blank_hours   = sw_out.blank_hours;
        ui_top_out.blank_minutes = sw_out.blank_minutes;
        ui_top_out.blank_seconds = sw_out.blank_seconds;

        sw_in.sw                 = ui_top_in.sw;
        sw_in.button             = ui_top_in.button;
      end
      // Timer
      2'b11: begin
        ui_top_out.led           = timer_out.led;
        ui_top_out.hours_disp    = timer_out.hours_disp;
        ui_top_out.minutes_disp  = timer_out.minutes_disp;
        ui_top_out.seconds_disp  = timer_out.seconds_disp;
        ui_top_out.blank_hours   = timer_out.blank_hours;
        ui_top_out.blank_minutes = timer_out.blank_minutes;
        ui_top_out.blank_seconds = timer_out.blank_seconds;

        timer_in.sw              = ui_top_in.sw;
        timer_in.button          = ui_top_in.button;
      end
      // Watch
      default: begin
        ui_top_out.led           = watch_out.led;
        ui_top_out.hours_disp    = watch_out.hours_disp;
        ui_top_out.minutes_disp  = watch_out.minutes_disp;
        ui_top_out.seconds_disp  = watch_out.seconds_disp;
        ui_top_out.blank_hours   = watch_out.blank_hours;
        ui_top_out.blank_minutes = watch_out.blank_minutes;
        ui_top_out.blank_seconds = watch_out.blank_seconds;

        watch_in.sw              = ui_top_in.sw;
        watch_in.button          = ui_top_in.button;
      end
    endcase
endmodule
